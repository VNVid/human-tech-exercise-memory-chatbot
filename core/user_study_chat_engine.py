...
from user_study_config import USE_BACKEND, SYSTEM_PROMPT_VERSION, EXTRACT_PREF_PROMPT_VERSION, MERGE_PREF_PROMPT_VERSION, USE_IMAGES
...
def generate_chat_response(user_msg: str, user_info: dict):
    ...
    print("Chat history:", part_chat_history)
    ...
    # 9) Build the response to return
    # Model decided not to show images
    if not img_ids or not USE_IMAGES:
        return text_resp
